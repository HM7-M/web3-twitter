...
const Home = () => {
  ...
  async function maticTweet() {
    ...
    let options = {
      contractAddress: "0x15d901115216423685FE620316694f4C83A8397E",
    ...
    <div className="mainContent">
      <div className="profileTweet">
        ...
        <div className="tweetBox">
          <TextArea label="" name="tweetTextArea" onChange={(e) => setTweet(e.target.value)} value="GM World!" type="text" width="95%"></TextArea>
          {selectedFile && (
